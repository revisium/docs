...
COPY docker/40-render-robots-txt.sh /docker-entrypoint.d/40-render-robots-txt.sh

RUN chmod +x /docker-entrypoint.d/40-render-search-config.sh /docker-entrypoint.d/40-render-robots-txt.sh
